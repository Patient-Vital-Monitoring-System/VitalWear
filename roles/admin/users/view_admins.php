    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                <div>
                    <h1><i class="fa fa-user-cog"></i> Admin Accounts</h1>
                </div>
                <div>
            ...
            <div class="breadcrumb">
                ...
                <span class="separator">/</span>
                <span class="current"><i class="fa fa-user-cog"></i> Admins</span>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>Active Users</h3>
                    <div class="stat-number"><?php echo number_format($active_admins); ?></div>
                </div>
            </div>
