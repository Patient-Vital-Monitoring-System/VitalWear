...
$admin = null;
try {
    $stmt = $conn->prepare("SELECT admin_id, admin_name, admin_email, admin_contact FROM admin WHERE admin_id = ?");
    if ($stmt) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email)) {
        ...
        try {
            ...
            $check_stmt = $conn->prepare("SELECT admin_id FROM admin WHERE admin_email = ? AND admin_id != ?");
            if ($check_stmt) {
                ...
                if ($check_result->num_rows > 0) {
                    ...
                    if ($update_stmt) {
                        ...
                        if ($update_stmt->execute()) {
                            ...
                            // Refresh data
                            $refresh_stmt = $conn->prepare("SELECT admin_id, admin_name, admin_email, admin_contact FROM admin WHERE admin_id = ?");
                            if ($refresh_stmt) {
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <div class="page-header">
                <h1><i class="fa fa-user-cog"></i> Update Admin</h1>
                <p>Edit admin account information</p>
            </div>
                ...
                <?php if ($admin): ?>
                    <div class="form-card">
                        <div class="form-header">
                            <h2><i class="fa fa-user-edit"></i> Admin Information</h2>
                            <p>Update the admin account details below</p>
                        </div>
