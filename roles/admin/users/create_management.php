...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Insert new management - only use columns that exist in database
        $hashed_password = password_hash($password, PASSWORD_DEFAULT);
        $stmt = $conn->prepare("
            INSERT INTO management (mgmt_name, mgmt_email, mgmt_password) 
            VALUES (?, ?, ?)
        ");
        ...
        if ($stmt->execute()) {
            ...
            throw new Exception('Error creating management account');
        }
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <div class="page-header">
                <h1><i class="fa fa-user-tie"></i> Create New Management</h1>
                <p>Add a new management staff member to the VitalWear system</p>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="form-card">
                    <div class="form-header">
                        <h2><i class="fa fa-user-plus"></i> Management Information</h2>
                        <p>Fill in the details below to create a new management account</p>
                    </div>
                    ...
                    <form method="POST" class="form-body">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input" 
                                       ...
                                       placeholder="Enter management staff's full name" required>
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Create Management Account
                            </button>
                        </div>
                    </form>
                </div>
