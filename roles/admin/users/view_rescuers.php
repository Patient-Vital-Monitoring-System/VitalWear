...
<body>
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <div class="breadcrumb">
                ...
                <span class="separator">/</span>
                <span class="current"><i class="fa fa-user-shield"></i> Rescuers</span>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number"><?php echo number_format($total_rescuers); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Active Users</h3>
                    <div class="stat-number"><?php echo number_format($active_rescuers); ?></div>
                </div>
            </div>
            ...
            <div class="users-grid">
                        ...
                        <div class="user-card" data-user-id="<?php echo htmlspecialchars($account['id']); ?>">
                            ...
                            <div class="user-details">
                                <div class="user-detail">
                                    ...
                                    <span class="role-badge">Rescuer</span>
                                </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <h3>No Rescuer Accounts Found</h3>
                        <p>There are currently no rescuer users in the system.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
            ...
            <div class="modal-body">
                ...
                <form action="create_rescuer.php" method="POST">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-submit">Create Rescuer</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="updateModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">
                    <i class="fa fa-edit"></i> Update Rescuer
                </h3>
                <button class="modal-close" onclick="closeModal('updateModal')">&times;</button>
            </div>
            <div class="modal-body">
                <div id="updateMessage"></div>
                <form id="updateForm" onsubmit="handleUpdateSubmit(event, 'rescuer')">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-submit">Update Rescuer</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="deleteModal" class="modal delete-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">
                    <i class="fa fa-trash"></i> Delete Rescuer
                </h3>
