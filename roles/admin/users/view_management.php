...
try {
    ...
    if ($table_check->num_rows == 0) {
        ...
        if ($create_table) {
            ...
            $insert2 = $conn->prepare("INSERT INTO management (mgmt_name, mgmt_email, mgmt_contact, mgmt_password, status) VALUES (?, ?, ?, ?, 'active')");
            $hashed_password2 = password_hash('admin123', PASSWORD_DEFAULT);
            $insert2->bind_param("ssss", 'Sarah Administrator', 'sarah@vitalwear.com', '+1-555-0101', $hashed_password2);
            $insert2->execute();
        }
    }
    
    // Fetch the data - only include columns we know exist
    $query = "
...
$active_management = 0;
foreach ($management_accounts as $management) {
    if (($management['status'] ?? 'active') === 'active') {
        $active_management++;
    }
}
?>
...
<body>
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="create_management.php" method="POST">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-submit">Create Management</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="updateModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">
                    <i class="fa fa-edit"></i> Update Management
                </h3>
                <button class="modal-close" onclick="closeModal('updateModal')">&times;</button>
            </div>
            <div class="modal-body">
                <div id="updateMessage"></div>
                <form id="updateForm" onsubmit="handleUpdateSubmit(event, 'management')">
    ...
    <div id="deleteModal" class="modal delete-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">
                    <i class="fa fa-trash"></i> Delete Management
                </h3>
