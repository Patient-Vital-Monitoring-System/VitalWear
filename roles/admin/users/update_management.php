...
$management = null;
try {
    $stmt = $conn->prepare("SELECT mgmt_id, mgmt_name, mgmt_email, mgmt_contact FROM management WHERE mgmt_id = ?");
    if ($stmt) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email)) {
        ...
        try {
            ...
            $check_stmt = $conn->prepare("SELECT mgmt_id FROM management WHERE mgmt_email = ? AND mgmt_id != ?");
            if ($check_stmt) {
                ...
                if ($check_result->num_rows > 0) {
                    ...
                    if ($update_stmt) {
                        ...
                        if ($update_stmt->execute()) {
                            ...
                            // Refresh data
                            $refresh_stmt = $conn->prepare("SELECT mgmt_id, mgmt_name, mgmt_email, mgmt_contact FROM management WHERE mgmt_id = ?");
                            if ($refresh_stmt) {
                                $refresh_stmt->bind_param("i", $management_id);
                                $refresh_stmt->execute();
                                $refresh_result = $refresh_stmt->get_result();
                                if ($refresh_result->num_rows > 0) {
                                    $management = $refresh_result->fetch_assoc();
                                }
                            }
                        } else {
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <div class="page-header">
                <h1><i class="fa fa-user-tie"></i> Update Management</h1>
                <p>Edit management account information</p>
            </div>
            ...
            <div class="form-container">
                ...
                <?php if ($management): ?>
                    <div class="form-card">
                        <div class="form-header">
                            <h2><i class="fa fa-user-edit"></i> Management Information</h2>
                            <p>Update the management account details below</p>
                        </div>
                        ...
                        <form method="POST" class="form-body">
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-input" 
                                           ...
                                           placeholder="Enter management's full name" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-input" 
                                           ...
                                           placeholder="management@vitalwear.com" required>
                                </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save"></i> Update Management
                                </button>
                            </div>
                        </form>
                    </div>
                <?php else: ?>
                    <div class="message error-message">
                        <i class="fa fa-exclamation-circle"></i>
                        Management not found or invalid ID.
                    </div>
                <?php endif; ?>
            </div>
        </main>
