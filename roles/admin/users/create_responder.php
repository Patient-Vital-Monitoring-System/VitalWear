...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($password)) {
        ...
        try {
            ...
            $check_query = "SELECT resp_id FROM responder WHERE resp_email = ?";
                    ...
                    if (!$conn) {
                        ...
                        try {
                            ...
                            if ($table_check->num_rows == 0) {
                                ...
                                $insert_columns = ['resp_name', 'resp_email', 'resp_password'];
                                ...
                                $insert_query = "INSERT INTO responder (" . implode(', ', $insert_columns) . ") VALUES (" . implode(', ', $insert_placeholders) . ")";
                                ...
                                if (!$insert_stmt) {
                                    ...
                                    if ($insert_stmt->execute()) {
                                        ...
                                        $error_message = "Error creating responder account: " . $insert_stmt->error;
                                    }
                                }
                            }
                        } catch (Exception $e) {
...
<body>
    <div class="container">
        <div class="breadcrumb">
            ...
            <span>/</span>
            <span>Create Responder</span>
        </div>

        <div class="form-card">
            <div class="form-header">
                <h1>Create Responder Account</h1>
                <p>Add a new responder to the VitalWear system</p>
            </div>
