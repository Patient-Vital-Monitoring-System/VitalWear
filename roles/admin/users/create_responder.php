...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare("
            INSERT INTO responder (resp_name, resp_email, resp_contact, resp_password, status, created_at) 
            VALUES (?, ?, ?, ?, 'active', NOW())
        ");
        $stmt->bind_param("ssss", $name, $email, $contact, $hashed_password);
        
        if ($stmt->execute()) {
            $success_message = "Responder account created successfully!";
        } else {
            throw new Exception('Error creating responder account');
        }
...
<head>
    ...
    <title>Create Responder Account - VitalWear Admin</title>
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                <div>
                    <h1><i class="fa fa-user-md"></i> Create Responder Account</h1>
                </div>
                <div>
            ...
            <div class="page-header">
                <h1><i class="fa fa-user-md"></i> Create New Responder</h1>
                <p>Add a new medical responder to the VitalWear system</p>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="form-card">
                    <div class="form-header">
                        <h2><i class="fa fa-user-plus"></i> Responder Information</h2>
                        <p>Fill in the details below to create a new responder account</p>
                    </div>
                    ...
                    <form method="POST" class="form-body">
                        ...
                        <div class="form-actions">
                            <a href="view_responders.php" class="btn btn-secondary">
                                <i class="fa fa-arrow-left"></i> Back to Responders
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Create Responder Account
                            </button>
                        </div>
                    </form>
                </div>
