        ...
        <main class="admin-main">
            ...
            <div class="content">
                <div class="content-header">
                    <h1 class="content-title">🚑 View Responder Accounts</h1>
                    <p class="content-subtitle">Read-only overview of all responder users in the system</p>
                </div>
                ...
                <div class="metrics-grid">
                    ...
                    <div class="metric-card">
                        ...
                        <div class="metric-label">Total Responder Users</div>
                    </div>
                ...
                <!-- Responder Accounts Table -->
                <div class="card">
                    <div class="card-header">
                        Responder ID | Name | Email Address | Contact Number | Status | Created Date
                    </div>
                    <div class="card-body">
                        <div class="table" style="overflow-x: auto;">
                            <table style="width: 100%; min-width: 900px;">
                                <thead>
                                    <tr>
                                        <th style="width: 12%;">Responder ID</th>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" style="text-align: center; padding: 3rem; color: var(--muted);">
                                                <div style="font-size: 1.1rem; margin-bottom: 0.5rem;">No Responder Accounts Found</div>
                                                <div style="font-size: 0.9rem;">There are currently no responder accounts in the system.</div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                ...
                <div style="text-align: center; margin-top: 2rem; padding: 2rem; color: var(--muted); border-top: 1px solid var(--border);">
                    <p style="margin: 0;">Admin Access - Read Only | Responder account overview for VitalWear IoT Health Monitoring Platform</p>
                </div>
