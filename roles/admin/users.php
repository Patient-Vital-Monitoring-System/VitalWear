...
<head>
    ...
    <style>
        ...
        .user-card.management::before {
            background: linear-gradient(90deg, #8B5CF6 0%, #7C3AED 100%);
        }

        .user-card.responder::before {
            background: linear-gradient(90deg, #10B981 0%, #059669 100%);
        }

        .user-card.rescuer::before {
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                <div>
                    <h1><i class="fa fa-users"></i> Staff Directory</h1>
                </div>
                <div>
            ...
            <div class="page-header">
                <h1><i class="fa fa-address-book"></i> Staff Directory</h1>
                <p>View all system users and their information</p>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>Admins</h3>
                    <div class="stat-number"><?php echo number_format($stats['admin_count']); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Management</h3>
                    <div class="stat-number"><?php echo number_format($stats['management_count']); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Responders</h3>
                    <div class="stat-number"><?php echo number_format($stats['responder_count']); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Rescuers</h3>
                    <div class="stat-number"><?php echo number_format($stats['rescuer_count']); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Active Responders</h3>
                    <div class="stat-number"><?php echo number_format($stats['active_responders']); ?></div>
                </div>
                
                <div class="stat-card">
                    <h3>Active Rescuers</h3>
                    <div class="stat-number"><?php echo number_format($stats['active_rescuers']); ?></div>
                </div>
            </div>
            ...
            <div class="users-grid">
                    ...
                    <?php foreach ($users as $user): ?>
                        <div class="user-card <?php echo htmlspecialchars($user['role']); ?>">
                            <div class="user-header">
                                <div class="user-avatar <?php echo htmlspecialchars($user['role']); ?>">
                                    <?php echo strtoupper(substr(htmlspecialchars($user['name']), 0, 2)); ?>
                                </div>
                                <div class="user-info">
                            ...
                            <div class="user-details">
                                ...
                                <?php if (!empty($user['contact'])): ?>
                                    <div class="user-detail">
                                        ...
                                        <span class="user-detail-value"><?php echo htmlspecialchars($user['contact']); ?></span>
                                    </div>
                                <?php endif; ?>
                ...
                <?php else: ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 48px; color: var(--text-secondary);">
                        <i class="fa fa-users" style="font-size: 3rem; margin-bottom: 16px; opacity: 0.5;"></i>
                        <h3 style="margin: 0 0 8px 0;">No users found</h3>
                        <p style="margin: 0;">There are currently no users in the system.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
