    ...
    <main class="main-content">
        ...
        <header class="header">
            <div class="header-title">
                <h1><i class="fa fa-check-double"></i> Device Return History</h1>
                <p>Track device returns and verification status</p>
            </div>
        ...
        <div class="content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo $verified_returns; ?></div>
            ...
            <section class="filters-section">
                ...
                <form method="GET" class="filters-grid">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="device_return_history.php" class="btn btn-secondary">
                    ...
                    <table class="modern-table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fa fa-user-shield"></i> Verified By</th>
                            ...
                            <?php if (empty($returns)): ?>
                                <tr>
                                    <td colspan="7" class="empty-state">
                                        ...
                                        <p>No return records found matching your criteria.</p>
                                        <a href="device_return_history.php" class="btn btn-primary">
                            ...
                            <?php else: ?>
                                <?php foreach ($returns as $return): ?>
                                    <tr>
                                        <td>
                                            <div class="device-info">
                                                ...
                                                <div class="device-details">
                                                    <div class="device-serial"><?php echo htmlspecialchars($return['dev_serial']); ?></div>
                                                    <div class="device-meta">ID: <?php echo $return['dev_id']; ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="person-info">
                                                <div class="person-avatar">
                                                    <?php echo strtoupper(substr($return['resp_name'], 0, 1)); ?>
                                                </div>
                                                <div class="person-details">
                                                    <div class="person-name"><?php echo htmlspecialchars($return['resp_name']); ?></div>
                                                    <div class="person-email"><?php echo htmlspecialchars($return['resp_email']); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="date-info">
                                                <i class="fa fa-calendar"></i>
                                                <span><?php echo date('M j, Y', strtotime($return['date_assigned'])); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="date-info">
                                                <i class="fa fa-calendar-check"></i>
                                                <span><?php echo date('M j, Y', strtotime($return['date_returned'])); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if ($return['mgmt_name']): ?>
                                                <div class="person-info">
                                                    <div class="person-avatar">
                                                        <?php echo strtoupper(substr($return['mgmt_name'], 0, 1)); ?>
                                                    </div>
                                                    <div class="person-details">
                                                        <div class="person-name"><?php echo htmlspecialchars($return['mgmt_name']); ?></div>
                                                        <div class="person-email">Management</div>
                                                    </div>
                                                </div>
                                            <?php else: ?>
        ...
        function exportToCSV() {
            ...
            for (let i = 1; i < table.rows.length; i++) {
                ...
                for (let j = 0; j < table.rows[i].cells.length; j++) {
                    ...
                    } else if (j === 5) { // Verified By column
                        const personName = table.rows[i].cells[j].querySelector('.person-name');
                        if (personName) {
                            cellText = personName.textContent.trim();
                        } else {
                            cellText = 'Not verified';
                        }
                    }
                    row.push(cellText);
                }
