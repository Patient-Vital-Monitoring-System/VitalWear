...
<body>
    <div class="container">
        <header class="page-header">
            <div>
                <h1 style="margin: 0;">📊 Device Assignment History</h1>
                <p style="margin: 5px 0 0 0; opacity: 0.9;">View and analyze device assignment records</p>
            </div>
            <div>
        ...
        <div class="filters-container">
            <form method="GET" class="filters-row">
                ...
                <div class="filter-actions">
                    ...
                    <a href="device_assignment_history.php" class="btn btn-secondary">Clear</a>
                </div>
            </form>
        </div>
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                <div class="stat-number"><?php echo $active_assignments; ?></div>
                <div class="stat-label">Active Assignments</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?php echo $returned_assignments; ?></div>
                    ...
                    <?php if (empty($assignments)): ?>
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 40px; color: #666;">
                                No assignment records found matching your criteria.
                            </td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($assignments as $assignment): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($assignment['dev_serial']); ?></td>
                                <td><?php echo htmlspecialchars($assignment['resp_name']); ?></td>
                                <td><?php echo htmlspecialchars($assignment['resp_email']); ?></td>
                                <td><?php echo htmlspecialchars($assignment['mgmt_name']); ?></td>
                                <td><?php echo date('M j, Y H:i', strtotime($assignment['date_assigned'])); ?></td>
                                <td>
                                    <?php 
                                    echo $assignment['date_returned'] 
                                        ? date('M j, Y H:i', strtotime($assignment['date_returned'])) 
                                        : '-'; 
                                    ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo strtolower($assignment['assignment_status']); ?>">
                                ...
                                <td>
                                    ...
                                    if ($assignment['verified_return']) {
                                        echo '<span class="status-badge status-returned">Yes</span>';
                                    } elseif ($assignment['date_returned']) {
                                        echo '<span class="status-badge status-active">No</span>';
                                    } else {
                                        echo '-';
                                    }
                                    ?>
